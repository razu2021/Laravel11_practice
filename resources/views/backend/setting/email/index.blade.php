                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <a href="{{route('email_setting.recycle')}}">
                            <button type="button" class="btn btn-warning position-relative mx-2">
                                ...
                                <button class="btn btn-success"><a class="text-white" href="{{route('email_setting.add')}}">Add New Information</a></button>
                            </div>
                        </div>
                        <hr>
                    <table class="table">
                            ...
                            <!-- action  -->
                             ...
                             <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{route('email_setting.edit',$data->id)}}">Edit</a></li>
                            
                                    <li><a class="dropdown-item" href="{{route('email_setting.view',$data->id)}}">View</a></li>
                                    <li><a class="dropdown-item" href="{{route('email_setting.softdelete',$data->id)}}" >Delete</a></li>
                                    <li><a class="dropdown-item" href="{{route('email_setting.testmail',$data->id)}}" >Delete</a></li>
                                    <hr>
                                    ...
                                    @endcan
                                    <li><a class="dropdown-item" href="{{route('email_setting.testmail',$data->id)}}" >Test Mail send</a></li>
