                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <a href="{{route('teacher_contact.recycle')}}">
                            <button type="button" class="btn btn-warning position-relative mx-2">
                                ...
                                <button class="btn btn-success"><a class="text-white" href="{{route('teacher_contact.add')}}">Add New Information</a></button>
                            </div>
                        </div>
                        <hr>
                    <table class="table">
                            ...
                            <!-- action  -->
                             ...
                             <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{route('teacher_contact.view',$data->teacher_contact_id)}}">View</a></li>
                                    <li><a class="dropdown-item" href="{{route('teacher_contact.softdelete',$data->teacher_contact_id)}}" >Delete</a></li>
                                </ul>
                                </div>
                             </td>
                            <!-- action end  -->
