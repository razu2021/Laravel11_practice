            ...
            <div class="card-body">
                ...
                <div class="student_menu">
                    <ul>
                        ...
                        <li><a href="#" type="button"  data-bs-toggle="modal" data-bs-target="#exampleModal{{$alldata->student_id}}course">Add Courses</a></li>
...
<div class="modal fade" id="exampleModal{{$alldata->student_id}}course" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Course Information add</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <section>
        <form action="{{route('student.course_submit')}}" method="POST" enctype="multipart/form-data">
            @csrf
                <h3>Add Course Infromation</h3>
                <input type="hidden" name="student_unique_id" id="phone"  class="form-control"  aria-describedby="name" value="{{$alldata->student_id}}">
                <div class="mb-3">
                    <label for="title" class="form-label">Student Phone Number </label>
                      <select name="course_id" id=""  class="form-control"  aria-describedby="name">
