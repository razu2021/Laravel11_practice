                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <button type="button" class="btn btn-warning position-relative mx-2">
                                ...
                                <button class="btn btn-success"><a class="text-white" href="{{route('teacher.add')}}">Add New Information</a></button>
                            </div>
                        </div>
                        <hr>
                    <table class="table">
                            ...
                            <!-- action  -->
                             ...
                             <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{route('teacher.view',$data->teacher_id)}}">View</a></li>
                                    <li><a class="dropdown-item" href="{{route('teacher.softdelete',$data->teacher_id)}}" >Delete</a></li>
                                </ul>
                                </div>
                             </td>
                            <!-- action end  -->
